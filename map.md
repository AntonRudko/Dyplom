...
│   ├── mocks/                       #   Предвизначені NFA та тестові слова
│   ├── tools/                       #   Візуалізація та перевірка слів
│   └── simple_benchmark.py          #   Простий бенчмарк: час алгоритмів на випадкових NFA
│
...
- **Analize/** — візуалізація + допоміжні NFA/слова + simple benchmark
- **Outputs/** + **At_Tests/** — згенеровані результати (картинки)
