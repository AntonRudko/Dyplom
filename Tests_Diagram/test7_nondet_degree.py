...
from Tests_Diagram.nfa_generators import gen_variable_nondet
...
def run():
    ...
    plt.tight_layout()
    plt.savefig("Table/Tests_Diagram/test7_nondet_degree.png", dpi=150)
    plt.close()
    print("\nSaved: Table/Tests_Diagram/test7_nondet_degree.png")
