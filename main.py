...
if __name__ == '__main__':
    ...
    # --- Epsilon NFA ---
    eps_dfa1, _eops1 = determinize_nfa_epsilon(nfa_test1_eps)
    eps_dfa2, _eops2 = determinize_brz_epsilon(nfa_test1_eps)
    eps_dfa3, _eops3 = determinize_transset_epsilon(nfa_test1_eps)

    print('\nEpsilon Tables')
    # --- Epsilon таблиці ---
    visualize_nfa_dfa(nfa_test1_eps, base_filename='Outputs/epsilon_tables/NFA')
    ...
    print('\nEpsilon Graphs')
    # --- Epsilon графи ---
    visualize_automaton_graph(nfa_test1_eps, filename='Outputs/epsilon_graphs/NFA_graph')
